<template>
    <div class="w-full h-full flex">
        <div class="w-[923px]">
            <div class="bg-[#7025FB] py-[30px] px-[60px]">
                <img alt="logo" src="../assets/logo.svg" />
            </div>
            <div class="h-screen bg-cover bg-no-repeat" style="background-image: url('src/assets/landing-bg.jpg')">
            </div>
        </div>
        <div class=" w-[997px] bg-[#FD5334] px-[85px]">
            <div class=" mt-[265px] flex items-center">
                <h1 class=" font-nunito text-[80px] font-extrabold text-white">
                    chess says
                </h1>
                <span class="ml-[26px] font-nunito font-bold text-xl uppercase">a lot about</span>
            </div>
            <h1 class=" font-nunito text-[80px] font-extrabold text-white">who we are</h1>
            <router-link class="btn btn_primary" to="/registration">
                Get started
